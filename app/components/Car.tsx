...
const Car = () => {
  const cars = [
    { id: 1, imgSrc: '/2151864_s.jpg', title: 'TOYOTA カローラ123', price: '2,400,000円（税込）', efficiency: 'JC08モード-WLTCモード33.6km/L', capacity: '乗車定員5名' },
    { id: 2, imgSrc: '/2281468_s.jpg', title: 'TOYOTA カローラ123', price: '2,400,000円（税込）', efficiency: 'JC08モード-WLTCモード33.6km/L', capacity: '乗車定員5名' },
    { id: 3, imgSrc: '/3258921_s.jpg', title: 'TOYOTA カローラ123', price: '2,400,000円（税込）', efficiency: 'JC08モード-WLTCモード33.6km/L', capacity: '乗車定員5名' },
  ];
